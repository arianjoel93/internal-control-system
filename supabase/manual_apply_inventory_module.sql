-- Ejecuta este archivo una sola vez en Supabase SQL Editor dentro del proyecto soporte_tectronic.
-- Crea el módulo de inventario y recarga el schema cache de Supabase/PostgREST.
...
grant select, insert, update on public.inventory_warehouses to authenticated;
